...
<!--- START OF STEP 12 IN THE PROJECT 6 PROGRAM AND DEPLOY_V1DOCX---->
				<!--- Part 3 -->
...
if (isset($_POST["btnDispatch"]))
{
	...
	$mysqli->close();
?>
<!-- After dispatching, redirect to logcallphp -->
...
<!---START of STEP 8.2 in the project 6_Program and doploy_v1.docx---->
